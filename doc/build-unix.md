...
If you want to build LMToken-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a LMToken-Qt executable will be
built by default.
...
2) The release is built with GCC and then "strip LMTokend" to strip the debug
