...
QString BitcoinUnits::name(int unit)
{
    ...
    case mBTC: return QString("mLMT");
    case uBTC: return QString::fromUtf8("μLMT");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("LMTs");
    case mBTC: return QString("Milli-LMTs (1 / 1,000)");
    case uBTC: return QString("Micro-LMTs (1 / 1,000,000)");
    default: return QString("???");
    }
}
