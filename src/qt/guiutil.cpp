...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "LMToken.lnk";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("LMToken-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  LMToken-Qt [" + tr("command-line options") + "]                     " + "\n";
